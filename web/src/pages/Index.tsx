      ...
      <section className="py-16 px-4 bg-card/30">
        <div className="container mx-auto text-center space-y-8 max-w-4xl">
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Join the community and contribute to the UML Editor project. Help us build the best tool for creating and sharing UML diagrams.
            </p>
          </div>
          <div className="flex items-center justify-center">
            <a 
              href="https://github.com/Shadowjumper3000/markboard" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="flex items-center space-x-2 bg-gradient-primary hover:opacity-90 shadow-elegant-md transition-smooth text-lg px-8 py-4 rounded-lg text-primary-foreground"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
                <path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.44 9.8 8.2 11.39.6.11.82-.26.82-.58 0-.29-.01-1.05-.02-2.06-3.34.73-4.04-1.61-4.04-1.61-.55-1.39-1.34-1.76-1.34-1.76-1.09-.75.08-.74.08-.74 1.2.08 1.83 1.23 1.83 1.23 1.07 1.83 2.8 1.3 3.48.99.11-.78.42-1.3.76-1.6-2.67-.3-5.47-1.34-5.47-5.97 0-1.32.47-2.4 1.23-3.25-.12-.3-.53-1.52.12-3.17 0 0 1-.32 3.3 1.23a11.5 11.5 0 0 1 3-.4c1.02.01 2.05.14 3 .4 2.3-1.55 3.3-1.23 3.3-1.23.65 1.65.24 2.87.12 3.17.77.85 1.23 1.93 1.23 3.25 0 4.64-2.8 5.67-5.47 5.97.43.37.81 1.1.81 2.22 0 1.6-.01 2.88-.01 3.27 0 .32.22.7.83.58C20.56 21.8 24 17.3 24 12c0-6.63-5.37-12-12-12z" />
              </svg>
